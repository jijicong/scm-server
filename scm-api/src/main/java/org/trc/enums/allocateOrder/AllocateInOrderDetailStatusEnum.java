 ...
 * 调拨入库单商品状态枚举
 */
public enum AllocateInOrderDetailStatusEnum {
    ...
    public static AllocateInOrderDetailStatusEnum queryNameByCode(Integer code){
        for(AllocateInOrderDetailStatusEnum sourceEnum: AllocateInOrderDetailStatusEnum.values()){
    ...
    AllocateInOrderDetailStatusEnum(Integer code, String name) {
        this.code = code;
        this.name = name;
    }
