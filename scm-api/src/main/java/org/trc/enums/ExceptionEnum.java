...
public enum ExceptionEnum{
    ...
    SUPPLIER_APPLY_QUERY_EXCEPTION("300101","供应商申请审核信息查询异常"),
    SUPPLIER_APPLY_UPDATE_EXCEPTION("300102","供应商申请审核信息更新异常"),
    SUPPLIER_APPLY_LOG_INSERT_EXCEPTION("300103","供应商申请审核日志信息保存异常"),
