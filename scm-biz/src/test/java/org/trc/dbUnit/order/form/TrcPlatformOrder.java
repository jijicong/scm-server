...
public class TrcPlatformOrder {

    public TrcPlatformOrder(){

    }

    public TrcPlatformOrder(String platformOrderCode, String channelCode, String platformCode, String userId, String userName, Integer itemNum, String payType, BigDecimal payment, BigDecimal pointsFee, BigDecimal totalFee, BigDecimal adjustFee, BigDecimal postageFee, BigDecimal totalTax, String needInvoice, String invoiceName, String invoiceType, String invoiceMain, String receiverProvince, String receiverCity, String receiverDistrict, String receiverAddress, String receiverZip, String receiverName, String receiverIdCard, String receiverIdCardFront, String receiverIdCardBack, String receiverPhone, String receiverMobile, String buyerArea, String zitiMemo, String zitiAddr, Byte anony, Integer obtainPointFee, BigDecimal realPointFee, String stepTradeStatus, BigDecimal stepPaidFee, Byte isClearing, String cancelReason, String cancelStatus, String status, Byte isVirtual, String ip, Byte type, BigDecimal discountPromotion, BigDecimal discountCouponShop, BigDecimal discountCouponPlatform, BigDecimal discountFee, String shippingType, String platformType, Byte rateStatus, String couponCode, String groupBuyStatus, String isDeleted, Date createTime, Date payTime, Date consignTime, Date receiveTime, Date updateTime, Date timeoutActionTime, Date endTime, String payBillId) {
