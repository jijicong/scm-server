...
//                        			.append(HTML_BR);
     ...
     * @throws Exception
     */
    private Map<String, Object> processOrder(PlatformOrder platformOrder, List<ShopOrder> shopOrderList, String orderType, List<ImportOrderInfo> importOrderInfoList, String operator) throws Exception {
        //设置企业购商品状态
