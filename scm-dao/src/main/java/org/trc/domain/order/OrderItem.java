...
public class OrderItem implements Serializable {
    ...
    // 商品sku库存id
    @ApiModelProperty(value="商品sku库存id")
    ...
    // 捆绑的子订单号
    @ApiModelProperty(value="捆绑的子订单号")
    @Length(max = 32)
    private String bindOid;
    // 子订单发货的快递公司
    @ApiModelProperty(value="子订单发货的快递公司")
    @Length(max = 32)
    private String logisticsCompany;
    // 子订单所在包裹的运单号
    @ApiModelProperty(value="子订单所在包裹的运单号")
    @Length(max = 32)
    ...
    // 商家三级类目签约佣金比例
    @ApiModelProperty(value="商家三级类目签约佣金比例")
