...
public enum TaxRateEnum {
    ...
    TaxRateEnum(String code, String name){
        this.code = code;
        this.name = name;
    }
     ...
     * @throws
     */
    public static TaxRateEnum getValidEnumByName(String name){
        for(TaxRateEnum validEnum : TaxRateEnum.values()){
     ...
     * @throws
     */
    public static TaxRateEnum getValidEnumByCode(String code){
        for(TaxRateEnum validEnum : TaxRateEnum.values()){
    ...
    public static JSONArray toJSONArray(){
        ...
        for(TaxRateEnum sexEnum : TaxRateEnum.values()){
